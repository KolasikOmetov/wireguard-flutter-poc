...
class Buttons extends StatelessWidget {
          ...
          return SizedBox(
            ...
            child: OutlinedButton(
              style: OutlinedButton.styleFrom(
                ...
                side: BorderSide(
                  width: 0.4,
                  color: onPressed == null ? (buttonDisabledColor ?? Colors.white24) : (borderColor ?? Colors.white54),
                  style: BorderStyle.solid,
                ),
                padding: horizontalPadding != null ? AppPadding.horizontal(horizontalPadding ?? 0) : AppPadding.allZero,
  ...
  Widget _content() {
    List<Widget> widgets;
    var color = onPressed == null ? textDisabledColor ?? _defaultTextDisabledColor : textColor ?? _defaultTextColor;
      ...
      widgets = [
        ...
        if (text != null)
          Texts(
            ...
            fontWeight:
                onPressed == null ? fontWeightDisabled ?? _defaultFontWeightDisabled : fontWeight ?? _defaultFontWeight,
